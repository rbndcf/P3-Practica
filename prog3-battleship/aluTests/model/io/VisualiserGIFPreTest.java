...
public class VisualiserGIFPreTest {
	...
	public void testVisualiserGIF() throws Exception {
		...
		IVisualiser iv = new VisualiserGIF(null);
	}
	...
	public void testShowEmpty2D() throws IOException {
		 ...
		 */
		assertTrue ("Comprueba testShowEmpty2D de forma aislada", compareFiles(DIRFILES + "emptyBoard2D.gif", "files/output.gif"));
	}
	...
	public void testShowEmpty3D() throws IOException {
		...
		System.out.println(Arrays.toString(game.getBoard1().show(false).split("\n")));
		System.out.println("----Board2---------");
		System.out.println(Arrays.toString(game.getBoard2().show(false).split("\n")));
		System.out.println("-----------------");
		
		VisualiserGIF vg = new VisualiserGIF(game);
		vg.show();
		vg.close();
		assertTrue("Comprueba testShowEmpty3D de forma aislada", compareFiles(DIRFILES + "emptyBoard3D.gif", "files/output.gif"));
	}
	...
	public void testShow2DWithShipsAndHits() throws IOException, InvalidCoordinateException, 
		...
		game = new Game(board1, board2, player1, player2);
		game.start();
		this.HitsInBoard1_2D();
		this.HitsInBoard2_2D();
		IVisualiser vis = new VisualiserGIF(game);
		vis.show();
		vis.close();
		assertTrue("Comprueba testShow2DWithShipsAndHits de forma aislada", compareFiles(DIRFILES + "Show2D.gif", "files/output.gif"));
	}
